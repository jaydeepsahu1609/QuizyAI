...
Instead of retrieving quiz questions from a database, the backend sends a structured prompt to an AI model via OpenRouter.
The AI returns a formatted quiz containing:
